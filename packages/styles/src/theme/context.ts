...
export const MissingThemeProviderError = new Error(
  '[@npm/mobydick-styles] useTheme hook was called outside of context, wrap your app with ThemeProvider component',
);
...
ThemeContext.displayName = '@npm/mobydick-styles/ThemeContext';
