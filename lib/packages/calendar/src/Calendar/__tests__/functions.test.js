...
describe('Calendar-functions', () => {
    ...
    it('calculateBoundaries', () => {
        expect((0, functions_1.calculateBoundaries)({
    ...
    it('calculateYearRange', () => {
        expect((0, functions_1.calculateYearRange)(2023)).toEqual([
            2019, 2020, 2021, 2022, 2023, 2024, 2025, 2026, 2027, 2028, 2029, 2030,
        ]);
    });
    it('calculateYearRange right', () => {
        expect((0, functions_1.calculateYearRange)(2030, types_1.IDirection.right)).toEqual([
            2031, 2032, 2033, 2034, 2035, 2036, 2037, 2038, 2039, 2040, 2041, 2042,
        ]);
    });
    it('calculateYearRange left', () => {
        expect((0, functions_1.calculateYearRange)(2019, types_1.IDirection.left)).toEqual([
            2007, 2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018,
        ]);
    });
    it('getAllDatesBetween', () => {
        expect((0, functions_1.getAllDatesBetween)(new Date('2022-12-15T00:00:00.000Z'), new Date('2022-12-15T00:00:00.000Z'), {
            colorPrime: {
                color: '#fff',
                textColor: '#000',
            },
    ...
    it('getAllDatesBetween length=5 isShowToday', () => {
        ...
        expect((0, functions_1.getAllDatesBetween)(new Date('2022-01-20T00:00:00.000Z'), new Date('2022-01-24T00:00:00.000Z'), {
            colorPrime: {
                color: '#fff',
                textColor: '#000',
            },
    ...
    it('getAllDatesBetween isShowToday === fromDate', () => {
        jest.setSystemTime(new Date('2022-01-22'));
        expect((0, functions_1.getAllDatesBetween)(new Date('2022-01-22T00:00:00.000Z'), new Date('2022-01-24T00:00:00.000Z'), {
            colorPrime: {
                color: '#fff',
                textColor: '#000',
            },
    ...
    it('getDateForCalendar', () => {
        expect((0, functions_1.getDateForCalendar)(new Date('2022-01-09'))).toEqual('2022-01-09');
    });
    it('isValidDate true', () => {
        expect((0, functions_1.isValidDate)('2022-01-09')).toBe(true);
    });
    it('isValidDate false', () => {
        expect((0, functions_1.isValidDate)('string')).toBe(false);
    });
});
